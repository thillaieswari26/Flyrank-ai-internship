...
☑️ Real task selected
☑️ Naive prompt created
☑️ Five additional iterations completed
☑️ Role assignment used
☑️ Context and motivation used
☑️ Few-shot examples used
☑️ Output structure used
☑️ Step decomposition used
☑️ Outputs documented
☑️ Changes and observed differences documented
☑️ Cross-model comparison included
☑️ Reusable prompt template created